...
import com.langyuye.library.dialog.utils.DensityUtil;

/**
 * Created by langyuye on 17-9-18.
 */
...
public class RadioButton extends CompoundButton {
    ...
    public RadioButton setColor(int color){
        this.mColor=color;
        return this;
    }
    public RadioButton setCheckColor(int color){
        this.mCheckedColor=color;
        thumbPaint.setColor(color);
        return this;
    }
    public RadioButton setSize(int size){
        mBorderRadius= DensityUtil.dip2px(getContext(),(float)size)/2;
        mThumbRadius=DensityUtil.dip2px(getContext(),(float)size)/4;
        return this;
    }
    @Override
